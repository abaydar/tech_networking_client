    ...
    return (
        <div class="flex border-b">
            ...
            <Link to="/users" class="-mb-px mr-1">
                <button class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold hover:bg-blue-100" id="users">Techies</button>
            </Link>
            <Link to="/posts" >
                <button class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold hover:bg-blue-100" id="posts">Tech Posts</button>
            </Link>
